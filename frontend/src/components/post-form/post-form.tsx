...
export default function PostForm() {
  return (
    ...
    <form className="px-5 py-3 flex flex-col bg-popover border-t border-primary gap-6">
      ...
      <div className="text-muted-foreground flex flex-col gap-1">
        ...
        <textarea id="title" className="h-50 pl-3 p-1 border-primary rounded-lg border"/>
      </div>
